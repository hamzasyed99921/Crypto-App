    ...
    <>
        ...
        <AccordionDetails>
          <Typography className="body">
            <ul className='list position-relative'>
                <li><span></span><a href="#">Buy Now</a></li>
                <li><span></span><a href="#">Auction</a></li>
            </ul>
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion className="color" >
        ...
        <AccordionDetails>
          ...
          <ul className='list'>
                ...
                <li><span></span><a href="#">Non-Curated</a></li>
            </ul>
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion className="color">
        ...
        <AccordionDetails>
          <Typography className="text-white">
          <ul className='list'>
                <li><span></span><a href="#">Art Blocks</a></li>
                <li><span></span><a href="#">Mutant Ape Yatch Club</a></li>
                <li><span></span><a href="#">Meebits</a></li>
                <li><span></span><a href="#">Bored Ape Yatch Club</a></li>
            </ul>
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion className="color">
        ...
        <AccordionDetails>
          <Typography className="text-white">
          <ul className='list'>
                <li><span></span><a href="#">Crypto Chain</a></li>
                <li><span></span><a href="#">Cronos</a></li>
                <li><span></span><a href="#">Ethereum</a></li>
                <li><span></span><a href="#">Polygon</a></li>
                <li><span></span><a href="#">Solana</a></li>
            </ul>
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion className="color">
        ...
        <AccordionDetails>
          <Typography className="text-white">
          <ul className='list'>
                <li><span></span><a href="#">Celebrities</a></li>
                <li><span></span><a href="#">Gaming</a></li>
                <li><span></span><a href="#">Sport</a></li>
                <li><span></span><a href="#">Music</a></li>
                <li><span></span><a href="#">Crypto</a></li>
                <li><span></span><a href="#">Cross Chain</a></li>
                <li><span></span><a href="#">PFP</a></li>
            </ul>
          </Typography>
        </AccordionDetails>
      </Accordion>
